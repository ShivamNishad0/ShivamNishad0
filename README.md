...
<head>
    ...
    <title>GitHub Profile Preview - Shivam Nishad</title>
    <style>
        body {
        ...
        .typing-animation {
            background: linear-gradient(45deg, #2E96F7, #764ba2);
            color: white;
            padding: 20px;
            border-radius: 8px;
            margin: 20px 0;
...
<body>
    ...
    <script>
        ...
        const typingText = document.querySelector('.typing-animation div');
        const messages = [
